    ...
    def enter(self):
        ...
        if action == "shoot!":
            print(dedent("""
                  ...
                  This completely ruins his brand new costume his motherbought him, which makes him fly into an insane rage
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        ...
        if guess == code:
            print(dedent("""
                  The container clicks open and the seal breaks, letting gas out. You hrab the neutron bommb and run as fast as ypu can     to the bridge where you must place it in the right spot.
                  """)) 
            return 'the_bridge'
